...
1. Review the chunk critically -- identify any gaps, unclear steps, or missing context
2. If issues found: fix them before proceeding
3. If clean: proceed to next chunk (or execution handoff if last chunk)
...
- Use `/sh:parallel` to dispatch independent tasks concurrently
- Fresh subagent per task

**If no subagents:**
- Execute plan in current session using `/sh:execute`
