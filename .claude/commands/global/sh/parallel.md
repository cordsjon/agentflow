...
**Instead:**
- Specific scope per agent
- Paste error messages and test names
- Constrain what can be changed
- Request summary of root cause and changes
...
3. **Run full suite** - Verify all fixes work together (use `/sh:verify`)
...
**Works with:**
- **`/sh:plan`** - Plans can identify parallelizable task groups
