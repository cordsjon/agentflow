...
4. **Route** — orchestrator annotates the item
...
5. **DOR check** — run `/sh:dor` to verify task passes Definition of Ready. If not, pause
...
13. **Save context** — run `/sh:handoff` to produce handoff with git state, decisions, open questions, resume checklist
